...
static const db_class_t db_classes_helper[] = {
  ...
  /*DB_DEFINE_CLASS(EditStyle,                                      db_parts_EDIT),*/
    DB_DEFINE_CLASS(Edit,                                           db_parts_EDIT),
        ...
        DB_DEFINE_CLASS(InactiveSearchBoxEditComposited::Edit,      db_parts_EDIT),
        DB_DEFINE_CLASS(MaxAddress::Edit,                           db_parts_EDIT),
        DB_DEFINE_CLASS(MaxAddressComposited::Edit,                 db_parts_EDIT),
        DB_DEFINE_CLASS(MaxInactiveAddress::Edit,                   db_parts_EDIT),
        DB_DEFINE_CLASS(MaxInactiveAddressComposited::Edit,         db_parts_EDIT),
        DB_DEFINE_CLASS(MaxInactiveSearchBoxEdit::Edit,             db_parts_EDIT),
  ...
  /*DB_DEFINE_CLASS(ScrollbarStyle,                                 db_parts_SCROLLBAR),*/
    ...
    DB_DEFINE_CLASS(SearchBox,                                      db_parts_SEARCHBOX),
        ...
        DB_DEFINE_CLASS(InactiveSearchBoxComposited::SearchBox,     db_parts_SEARCHBOX),
        DB_DEFINE_CLASS(MaxInactiveSearchBox::SearchBox,            db_parts_SEARCHBOX),
        DB_DEFINE_CLASS(MaxInactiveSearchBoxComposited::SearchBox,  db_parts_SEARCHBOX),
...
db_class_display_name(const db_class_t* cls, TCHAR* buffer, UINT bufsize)
{
    ...
    colon0 = _tcschr(cls->name, _T(':'));
    colon1 = _tcsrchr(cls->name, _T(':'));

    if(colon1 != NULL  &&  colon1 - colon0 == 1)
        _sntprintf(buffer, bufsize, _T("%s [%.*s]"), colon1 + 1, colon0 - cls->name, cls->name);
    else
        _sntprintf(buffer, bufsize, cls->name);
